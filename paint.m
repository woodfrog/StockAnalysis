...
VOL_RECORD   = zeros(endCount-beginCount+1,1);
...
for i = beginCount:endCount %循环每一天
    ...
    if dayIndex >= LONG_TIME + PREMISE_DAY
        SHIFT_VOL(dayIndex) = strategy_volume(dayIndex, volIndex, VOL_AVR, VOL_RECORD, VOL_START_DAY, historyClose);
