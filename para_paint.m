%%set parameter
STOCK_NUM = 300352;     %股票代号
BEGIN_DATE =20120110;   %最小20110104
...
% IN_PERCENT = 0.5; %每次投入交易的钱占净值的百分比

PREMISE_DAY = 7; %每天进行大前提判断时，所用到数据涵盖的天数
...
STOP_LOSS_PROP = 0.9; % 当小于极大值的STOP_LOSS_PROP倍时止损
